...
namespace HW2_WinForms.HashSet.Tests
{
    ...
    public class DistinctTests
    {
        ...
        /// <summary>
        /// Contains the tests for the second implementation of calculating the distinct elements of a list.
        /// </summary>
        [Test]
        public void TestCalculateDistinctInConstantMemory()
        {
            // Tests based off: https://docs.microsoft.com/en-us/dotnet/core/testing/unit-testing-best-practices
            // Arrange
            List<int> testList = new List<int>();
            ...
            // Act
            int actual = Distinct.CalculateDistinctInConstantMemory(testList);
            ...
            actual = Distinct.CalculateDistinctInConstantMemory(testList);
            ...
            // integer above 20,000 in list (exceptional/overflow case)
            Assert.Throws<System.ArgumentOutOfRangeException>(() => Distinct.CalculateDistinctInConstantMemory(testList)); // from class example
            ...
            // integer below 0 in list (exceptional/overflow case)
            Assert.Throws<System.ArgumentOutOfRangeException>(() => Distinct.CalculateDistinctInConstantMemory(testList));
        ...
        /// <summary>
        /// Contains the tests for the third implementation of calculating the distinct elements of a list.
        /// </summary>
        [Test]
        public void TestCalculateDistinctUsingSort()
        {
            // Tests based off: https://docs.microsoft.com/en-us/dotnet/core/testing/unit-testing-best-practices
            // Arrange
            List<int> testList = new List<int>();
            ...
            // Act
            int actual = Distinct.CalculateDistinctUsingSort(testList);
            ...
            actual = Distinct.CalculateDistinctUsingSort(testList);
            ...
            // integer above 20,000 in list (exceptional/overflow case)
            Assert.Throws<System.ArgumentOutOfRangeException>(() => Distinct.CalculateDistinctUsingSort(testList)); // from class example
            ...
            // integer below 0 in list (exceptional/overflow case)
            Assert.Throws<System.ArgumentOutOfRangeException>(() => Distinct.CalculateDistinctUsingSort(testList));
